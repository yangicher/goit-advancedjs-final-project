import{a as y}from"./vendor-DDD7fsZd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const B="https://your-energy.b.goit.study/api/";y.defaults.headers.post["Content-Type"]="application/json";const C=async(a,e)=>{try{return(await y.get(`${B}${a}`,{params:e})).data}catch(t){throw console.error("Error in get:",t),t}},j=async(a,e)=>{try{return(await y.patch(`${B}${a}`,e)).data}catch(t){throw console.error("Error in patch:",t),t}},W=async(a,e)=>{try{return(await y.post(`${B}${a}`,e)).data}catch(t){return console.error("Error in post:",t),t.response}},M=document.getElementById("subscribe-form"),F=M?.querySelector(".form_input");M&&F&&M.addEventListener("submit",async function(a){a.preventDefault();const e=F.value.trim();await W("subscription",{email:e})});const k=()=>{const a=localStorage.getItem("favorites");try{return a?JSON.parse(a):[]}catch(e){return console.error("Failed to parse favorites:",e),[]}};class Q{constructor(e="#modal-root"){this.#r=e}#r;#i="";#t=!1;#s=0;#a="";#l="";get#e(){return document.querySelector(this.#r)}get#h(){return this.#e?.querySelector(".modal-backdrop")}get#m(){return this.#e?.querySelector("#menu-close-button")}get#d(){return this.#e?.querySelectorAll(".star-rating svg")}get#n(){return this.#e?.querySelector(".modal-rating-count")}get#o(){return this.#e?.querySelector("#send-rating-button")}get#c(){return this.#e?.querySelector("#rating-form")}get#p(){return this.#e?.querySelector("#email")}get#g(){return this.#e?.querySelector("#comment")}#v(){this.#i="",this.#s=0,this.#a="",this.#l="",this.#t=!1,this.#c&&this.#c.reset?.(),this.#n&&(this.#n.textContent="0.0"),this.#o&&this.#o.setAttribute("disabled","true")}#u(){return`
    ...
    </div>`}#n=e=>{e.target.classList.contains("modal-backdrop")&&this.hideModal()};#o=()=>{const e=k(),t=this.#t.name,s=e.findIndex(i=>i.name===t);s!==-1?e.splice(s,1):e.push(this.#t),localStorage.setItem("favorites",JSON.stringify(e)),this.#c()};#c=()=>{const e=this.#e;if(!e)return;const t=k().some(s=>s.name===this.#t.name);e.innerHTML=t?'Remove from favorites <svg><use href="./img/icons.svg#icon-trash"></use></svg>':'Add to favorites <svg><use href="./img/icons.svg#icon-heart"></use></svg>'};#p(e){const t=Math.floor(e),s=5-t;return`
  ...
  `),`<div class="muscles-pagination">${t.join("")}</div>`}function J(a,e){const t=[];if(e<=5)for(let s=1;s<=e;s++)t.push(`<button class="page-btn ${s===a?"active":""}" data-page="${s}">${s}</button>`);else{t.push(`<button class="page-btn ${a===1?"active":""}" data-page="1">1</button>`),a>3&&t.push('<span class="page-dots">...</span>');const s=Math.max(2,a-1),i=Math.min(e-1,a+1);for(let r=s;r<=i;r++)r!==1&&r!==e&&t.push(`<button class="page-btn ${r===a?"active":""}" data-page="${r}">${r}</button>`);a<e-2&&t.push('<span class="page-dots">...</span>'),e>1&&t.push(`<button class="page-btn ${e===a?"active":""}" data-page="${e}">${e}</button>`)}return t.join("")}const c={FILTERS_PER_PAGE:12,EXERCISES_PER_PAGE:10,SEARCH_DEBOUNCE_DELAY:1e3,ANIMATION_DURATION:0,DEFAULT_FILTER:"Muscles"},u={musclesGrid:"#muscles-grid",tabs:".tab",searchSection:"#search-section",breadcrumb:"#breadcrumb",searchInput:".search-input",searchClearBtn:"#search-clear-btn"},h={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"};class Y{constructor(){this.currentPage=1,this.totalPages=1,this.currentFilter=c.DEFAULT_FILTER,this.selectedBodyPart="",this.allExercises=[],this.filteredExercises=[],this.exercisesMap=new Map,this.currentHeight=0,this.searchTimeout=null}reset(){this.currentPage=1,this.totalPages=1,this.allExercises=[],this.filteredExercises=[],this.exercisesMap.clear(),this.selectedBodyPart="",this.clearSearchTimeout()}clearSearchTimeout(){this.searchTimeout&&(clearTimeout(this.searchTimeout),this.searchTimeout=null)}}class o{static getElementById(e){return document.getElementById(e.replace("#",""))}static querySelectorAll(e){return document.querySelectorAll(e)}static show(e){e.style.display="block"}static hide(e){e.style.display="none"}static setContent(e,t){e.innerHTML=t}static measureContentHeight(e,t){const s=document.createElement("div");Object.assign(s.style,{visibility:"hidden",position:"absolute",top:"-9999px",width:`${t}px`}),s.innerHTML=e,document.body.appendChild(s);const i=s.scrollHeight;return document.body.removeChild(s),i}static animateHeight(e,t,s=c.ANIMATION_DURATION){e.style.height=`${t}px`,setTimeout(()=>{e.style.height="auto"},s)}}class I{static async fetchFilters(e,t=1){return await C("filters",{filter:e,page:t,limit:c.FILTERS_PER_PAGE})}static async fetchExercises(e,t,s=1){const i={page:s,limit:c.EXERCISES_PER_PAGE};switch(t){case h.BODY_PARTS:i.bodypart=e;break;case h.MUSCLES:i.muscles=e;break;case h.EQUIPMENT:i.equipment=e;break}return await C("exercises",i)}}class g{static filterCard(e){return`
    ...
    `}}class z{constructor(){this.state=new Y,this.elements=this.initializeElements(),this.modal=new R,this.exercisesList=null,this.elements&&this.setupEventListeners()}initializeElements(){const e={musclesGrid:o.getElementById(u.musclesGrid),tabs:o.querySelectorAll(u.tabs),searchSection:o.getElementById(u.searchSection),breadcrumb:o.getElementById(u.breadcrumb),searchClearBtn:o.getElementById(u.searchClearBtn)};return!e.musclesGrid||!e.searchSection?null:(e.searchInput=e.searchSection.querySelector(u.searchInput),e)}setupEventListeners(){this.setupTabListeners(),this.setupSearchListeners(),this.setupExerciseClickListeners()}setupTabListeners(){this.elements.tabs.forEach(e=>{e.addEventListener("click",()=>this.handleTabSwitch(e))})}setupSearchListeners(){this.elements.searchInput.addEventListener("input",e=>this.handleSearchInput(e)),this.elements.searchInput.addEventListener("keydown",e=>this.handleSearchKeydown(e)),this.elements.searchClearBtn.addEventListener("click",e=>this.handleSearchClear(e))}setupExerciseClickListeners(){this.elements.musclesGrid.addEventListener("click",e=>{const t=e.target.closest(".muscle-card");if(t){const r=t.dataset.filter,n=t.dataset.filterType;this.renderExercisesList(r,n,"",1);return}if(e.target.closest(".back-btn")){this.state.reset(),this.clearSearchInput(),this.renderFilters(this.state.currentFilter,1);return}const i=e.target.closest(".page-btn");if(i){this.handlePagination(i,this.state.selectedBodyPart?"exercises":"filters");return}})}async renderFilters(e=c.DEFAULT_FILTER,t=1){this.hideSearchAndBreadcrumb(),this.state.selectedBodyPart="",this.prepareContainer();try{const s=await I.fetchFilters(e,t);if(this.updateFilterState(s,e),!s.results.length){this.showError("No items found.");return}const i=this.buildFiltersContent(s.results),r=$(t,this.state.totalPages),n=g.contentWrapper(i,r);this.updateContainerWithAnimation(n)}catch{this.showError("Failed to load data.")}}async renderExercisesList(e,t,s="",i=1){this.showSearchAndBreadcrumb(e),s||this.clearSearchInput(),this.prepareContainer();try{const r=await I.fetchExercises(e,t,i);this.updateExercisesState(r,e);const n=this.filterExercises(s);if(n.length===0){this.showNoExercisesFound(s);return}const E=`<button class="back-btn"><span class="arrow">←</span> Back to ${this.state.currentFilter}</button>`,m=s?"":$(i,this.state.totalPages),S=`
      ...
      `;this.updateContainerWithAnimation(S);const b=this.elements.musclesGrid.querySelector(".exercises-list-container");this.exercisesList=new D({container:b,showRating:!0,showRemoveBtn:!1,onStartClick:p=>{console.log("onStartClick called with ID:",p);const q=this.state.exercisesMap.get(p);console.log("Exercise found:",q),q?this.modal.showModal(q):console.error("Exercise not found in exercisesMap for ID:",p)}}),this.exercisesList.render(n)}catch{this.showError("Failed to load exercises.")}}buildFiltersContent(e){return`<div class="muscles-cards-wrapper">${e.map(s=>g.filterCard(s)).join("")}</div>`}updateFilterState(e,t){this.state.totalPages=e.totalPages,this.state.currentFilter=t}updateExercisesState(e,t){this.state.allExercises=e.results||[],this.state.totalPages=e.totalPages||1,this.state.selectedBodyPart=t,this.state.exercisesMap.clear(),this.state.allExercises.forEach(s=>{this.state.exercisesMap.set(s._id,s)})}filterExercises(e){return e?this.state.filteredExercises=this.state.allExercises.filter(t=>t.name.toLowerCase().includes(e.toLowerCase())):this.state.filteredExercises=[...this.state.allExercises],this.state.filteredExercises}hideSearchAndBreadcrumb(){o.hide(this.elements.searchSection),o.hide(this.elements.breadcrumb)}showSearchAndBreadcrumb(e){o.show(this.elements.searchSection),o.show(this.elements.breadcrumb),this.elements.breadcrumb.textContent=`/ ${e.charAt(0).toUpperCase()+e.slice(1)}`}prepareContainer(){this.state.currentHeight===0&&(this.state.currentHeight=this.elements.musclesGrid.getBoundingClientRect().height||600),this.elements.musclesGrid.style.height=`${this.state.currentHeight}px`,o.setContent(this.elements.musclesGrid,g.loadingTemplate(this.state.currentHeight))}updateContainerWithAnimation(e){const t=o.measureContentHeight(e,this.elements.musclesGrid.offsetWidth);o.setContent(this.elements.musclesGrid,e),o.animateHeight(this.elements.musclesGrid,t),this.state.currentHeight=t}showError(e){o.setContent(this.elements.musclesGrid,g.errorTemplate(e))}showNoExercisesFound(e){const t=`No exercises found${e?` matching "${e}"`:""}.`,s=`<button class="back-btn"><span class="arrow">←</span> Back to ${this.state.currentFilter}</button>`;o.setContent(this.elements.musclesGrid,g.errorTemplate(t)+s)}handleTabSwitch(e){this.elements.tabs.forEach(i=>i.classList.remove("active")),e.classList.add("active"),this.state.reset(),this.clearSearchInput();const s={muscles:h.MUSCLES,"body-parts":h.BODY_PARTS,equipment:h.EQUIPMENT}[e.dataset.tab]||c.DEFAULT_FILTER;this.renderFilters(s,1)}handleSearchInput(e){const t=e.target.value.trim();this.updateSearchClearButton(),this.state.clearSearchTimeout(),this.state.searchTimeout=setTimeout(()=>{this.performSearch(t)},c.SEARCH_DEBOUNCE_DELAY)}handleSearchKeydown(e){e.key==="Enter"&&(e.preventDefault(),this.state.clearSearchTimeout(),this.performSearch(e.target.value.trim()))}handleSearchClear(e){e.preventDefault(),this.clearSearch()}performSearch(e){this.state.selectedBodyPart&&this.renderExercisesList(this.state.selectedBodyPart,this.state.currentFilter,e,1)}clearSearch(){this.elements.searchInput.value="",this.updateSearchClearButton(),this.state.clearSearchTimeout(),this.state.selectedBodyPart&&this.performSearch("")}clearSearchInput(){this.elements.searchInput.value="",this.updateSearchClearButton()}updateSearchClearButton(){const e=this.elements.searchInput.value.trim().length>0;this.elements.searchClearBtn.style.display=e?"flex":"none"}handlePagination(e,t){const{page:s}=e.dataset;let i=this.state.currentPage;s==="prev"&&this.state.currentPage>1?i=this.state.currentPage-1:s==="next"&&this.state.currentPage<this.state.totalPages?i=this.state.currentPage+1:s&&!isNaN(s)&&(i=parseInt(s)),i!==this.state.currentPage&&(this.state.currentPage=i,t==="filters"?this.renderFilters(this.state.currentFilter,i):this.renderExercisesList(this.state.selectedBodyPart,this.state.currentFilter,"",i))}init(){this.elements&&this.renderFilters(c.DEFAULT_FILTER,1)}}function P(){new z().init()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",P):P();let w=document.getElementById("scrollTopButton");w&&(w.onclick=function(){X()});window.onscroll=function(){K()};function K(){document.body.scrollTop>20||document.documentElement.scrollTop>20?w.style.display="flex":w.style.display="none"}function X(){document.body.scroll({behavior:"smooth",top:0}),document.documentElement.scroll({behavior:"smooth",top:0})}const l=document.getElementById("mobile-menu-btn"),d=document.getElementById("mobile-menu-backdrop");document.getElementById("mobile-menu");const A=document.getElementById("mobile-menu-close-btn"),H=document.querySelectorAll(".mobile-nav-link"),O=document.body;function V(){d.classList.add("is-open"),l.classList.add("is-active"),l.setAttribute("aria-expanded","true"),l.setAttribute("aria-label","Close mobile menu"),O.style.overflow="hidden"}function f(){d.classList.remove("is-open"),l.classList.remove("is-active"),l.setAttribute("aria-expanded","false"),l.setAttribute("aria-label","Open mobile menu"),O.style.overflow=""}function Z(){d.classList.contains("is-open")?f():V()}l&&l.addEventListener("click",Z);A&&A.addEventListener("click",f);d&&d.addEventListener("click",a=>{a.target===d&&f()});H.forEach(a=>{a.addEventListener("click",f)});document.addEventListener("keydown",a=>{a.key==="Escape"&&d.classList.contains("is-open")&&f()});function ee(){const e=window.location.pathname.includes("favorites")?"favorites":"index.html";document.querySelectorAll(".nav-link").forEach(t=>{t.classList.toggle("selected",t.href.includes(e))}),H.forEach(t=>{t.classList.toggle("active",t.href.includes(e))})}document.addEventListener("DOMContentLoaded",ee);let N="",T=null;window.addEventListener("DOMContentLoaded",async()=>{try{T=await te(),_()}catch(a){console.error("Помилка ініціалізації:",a)}});window.addEventListener("resize",()=>{(window.innerWidth>=1440?"desktop":"mobile")!==N&&_()});async function te(){const a=localStorage.getItem("quoteData"),e=new Date().toISOString().slice(0,10);if(a){const i=JSON.parse(a);if(i.date===e)return i}const t=await C("quote"),s={date:e,author:t.author,quote:t.quote};return localStorage.setItem("quoteData",JSON.stringify(s)),s}function _(){const a=window.innerWidth>=1440;N=a?"desktop":"mobile";const e=document.querySelector(".js-quote-container");e&&e.remove();const t=document.querySelector(".favorites-section"),s=document.createElement("div");if(s.className="js-quote-container",t){s.innerHTML=se(T);const n=document.querySelector(".left-column");n&&n.prepend(s);return}s.innerHTML=ie(T);const i=document.querySelector(".exercises-sidebar"),r=document.querySelector(".exercises-page");a&&i?(i.innerHTML="",i.appendChild(s)):r&&(s.classList.add("container"),r.insertAdjacentElement("afterend",s))}function se(a){return`<div class="Fquote" id="quote">
...
`}const U=document.getElementById("heroContainer"),v=document.getElementById("heroTags"),L=U?.querySelector(".hero-side"),x=U?.querySelector(".hero-bottom-image");function G(){!v||!L||!x||(window.innerWidth>=1440?L.contains(v)||L.appendChild(v):v.previousElementSibling!==x&&x.insertAdjacentElement("afterend",v))}function ae(a,e){let t=!1;return function(...s){t||(a.apply(this,s),t=!0,setTimeout(()=>{t=!1},e))}}G();window.addEventListener("resize",ae(G,200));document.addEventListener("DOMContentLoaded",()=>{re()});function re(){const a=JSON.parse(localStorage.getItem("favorites"))||[],e=document.getElementById("favoritesList");if(!e)return;const t=new R,s=new D({container:e,showRating:!1,showRemoveBtn:!0,onStartClick:i=>{console.log("Favorites onStartClick called with ID:",i);const r=a.find(n=>(n._id||n.id)===i);console.log("Exercise found in favorites:",r),r?t.showModal(r):console.error("Exercise not found in favorites for ID:",i)},onRemoveClick:i=>{ne(i,s)}});s.render(a)}function ne(a,e){let t=JSON.parse(localStorage.getItem("favorites"))||[];t=t.filter(s=>(s._id||s.id)!==a),localStorage.setItem("favorites",JSON.stringify(t)),e.removeExercise(a)}
//# sourceMappingURL=index-Xfrax_8K.js.map
