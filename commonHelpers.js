import{a as L}from"./assets/vendor-DDD7fsZd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const T="https://your-energy.b.goit.study/api/";L.defaults.headers.post["Content-Type"]="application/json";const E=async(a,e)=>{try{return(await L.get(`${T}${a}`,{params:e})).data}catch(t){throw console.error("Error in get:",t),t}},D=async(a,e)=>{try{return(await L.patch(`${T}${a}`,e)).data}catch(t){throw console.error("Error in patch:",t),t}},l={FILTERS_PER_PAGE:12,EXERCISES_PER_PAGE:10,SEARCH_DEBOUNCE_DELAY:1e3,ANIMATION_DURATION:0,DEFAULT_FILTER:"Muscles"},h={musclesGrid:"#muscles-grid",tabs:".tab",searchSection:"#search-section",breadcrumb:"#breadcrumb",searchInput:".search-input",searchClearBtn:"#search-clear-btn"},m={MUSCLES:"Muscles",BODY_PARTS:"Body parts",EQUIPMENT:"Equipment"};class N{constructor(){this.currentPage=1,this.totalPages=1,this.currentFilter=l.DEFAULT_FILTER,this.selectedBodyPart="",this.allExercises=[],this.filteredExercises=[],this.currentHeight=0,this.searchTimeout=null}reset(){this.currentPage=1,this.totalPages=1,this.allExercises=[],this.filteredExercises=[],this.selectedBodyPart="",this.clearSearchTimeout()}clearSearchTimeout(){this.searchTimeout&&(clearTimeout(this.searchTimeout),this.searchTimeout=null)}}class o{static getElementById(e){return document.getElementById(e.replace("#",""))}static querySelectorAll(e){return document.querySelectorAll(e)}static show(e){e.style.display="block"}static hide(e){e.style.display="none"}static setContent(e,t){e.innerHTML=t}static measureContentHeight(e,t){const s=document.createElement("div");Object.assign(s.style,{visibility:"hidden",position:"absolute",top:"-9999px",width:`${t}px`}),s.innerHTML=e,document.body.appendChild(s);const i=s.scrollHeight;return document.body.removeChild(s),i}static animateHeight(e,t,s=l.ANIMATION_DURATION){e.style.height=`${t}px`,setTimeout(()=>{e.style.height="auto"},s)}}class S{static async fetchFilters(e,t=1){return await E("filters",{filter:e,page:t,limit:l.FILTERS_PER_PAGE})}static async fetchExercises(e,t,s=1){const i={page:s,limit:l.EXERCISES_PER_PAGE};switch(t){case m.BODY_PARTS:i.bodypart=e;break;case m.MUSCLES:i.muscles=e;break;case m.EQUIPMENT:i.equipment=e;break}return await E("exercises",i)}}class c{static filterCard(e){return`
    ...
    `}}class O{constructor(){if(this.state=new N,this.elements=this.initializeElements(),!this.elements){console.error("Failed to initialize ExercisesManager: required DOM elements not found");return}this.setupEventListeners()}initializeElements(){const e={musclesGrid:o.getElementById(h.musclesGrid),tabs:o.querySelectorAll(h.tabs),searchSection:o.getElementById(h.searchSection),breadcrumb:o.getElementById(h.breadcrumb),searchClearBtn:o.getElementById(h.searchClearBtn)};return!e.musclesGrid||!e.searchSection?(console.error("Essential DOM elements not found for exercises functionality"),null):(e.searchInput=e.searchSection.querySelector(h.searchInput),e)}setupEventListeners(){this.setupTabListeners(),this.setupSearchListeners()}setupTabListeners(){this.elements.tabs.forEach(e=>{e.addEventListener("click",()=>this.handleTabSwitch(e))})}setupSearchListeners(){this.elements.searchInput.addEventListener("input",e=>this.handleSearchInput(e)),this.elements.searchInput.addEventListener("keydown",e=>this.handleSearchKeydown(e)),this.elements.searchClearBtn.addEventListener("click",e=>this.handleSearchClear(e))}async renderFilters(e=l.DEFAULT_FILTER,t=1){this.hideSearchAndBreadcrumb(),this.state.selectedBodyPart="",this.prepareContainer();try{const s=await S.fetchFilters(e,t);if(this.updateFilterState(s,e),!s.results.length){this.showError("No items found.");return}const i=this.buildFiltersContent(s.results),r=c.pagination(t,this.state.totalPages),n=c.contentWrapper(i,r);this.updateContainerWithAnimation(n),this.attachFilterEventListeners()}catch{this.showError("Failed to load data.")}}async renderExercisesList(e,t,s="",i=1){this.showSearchAndBreadcrumb(e),s||this.clearSearchInput(),this.prepareContainer();try{const r=await S.fetchExercises(e,t,i);this.updateExercisesState(r,e);const n=this.filterExercises(s);if(n.length===0){this.showNoExercisesFound(s);return}const f=this.buildExercisesContent(n,e),g=s?"":c.pagination(i,this.state.totalPages),b=c.contentWrapper(f,g);this.updateContainerWithAnimation(b),this.attachExercisesEventListeners(s)}catch{this.showError("Failed to load exercises.")}}buildFiltersContent(e){return`<div class="muscles-cards-wrapper">${e.map(s=>c.filterCard(s)).join("")}</div>`}buildExercisesContent(e,t){const s=e.map(r=>c.exerciseCard(r)).join(""),i=`<button class="back-btn"><span class="arrow">←</span> Back to ${this.state.currentFilter}</button>`;return`<div class="exercises-list">${s}</div>${i}`}updateFilterState(e,t){this.state.totalPages=e.totalPages,this.state.currentFilter=t}updateExercisesState(e,t){this.state.allExercises=e.results||[],this.state.totalPages=e.totalPages||1,this.state.selectedBodyPart=t}filterExercises(e){return e?this.state.filteredExercises=this.state.allExercises.filter(t=>t.name.toLowerCase().includes(e.toLowerCase())):this.state.filteredExercises=[...this.state.allExercises],this.state.filteredExercises}hideSearchAndBreadcrumb(){o.hide(this.elements.searchSection),o.hide(this.elements.breadcrumb)}showSearchAndBreadcrumb(e){o.show(this.elements.searchSection),o.show(this.elements.breadcrumb),this.elements.breadcrumb.textContent=`/ ${e.charAt(0).toUpperCase()+e.slice(1)}`}prepareContainer(){this.state.currentHeight===0&&(this.state.currentHeight=this.elements.musclesGrid.getBoundingClientRect().height||600),this.elements.musclesGrid.style.height=`${this.state.currentHeight}px`,o.setContent(this.elements.musclesGrid,c.loadingTemplate(this.state.currentHeight))}updateContainerWithAnimation(e){const t=o.measureContentHeight(e,this.elements.musclesGrid.offsetWidth);o.setContent(this.elements.musclesGrid,e),o.animateHeight(this.elements.musclesGrid,t),this.state.currentHeight=t}showError(e){o.setContent(this.elements.musclesGrid,c.errorTemplate(e))}showNoExercisesFound(e){const t=`No exercises found${e?` matching "${e}"`:""}.`,s=`<button class="back-btn"><span class="arrow">←</span> Back to ${this.state.currentFilter}</button>`;o.setContent(this.elements.musclesGrid,c.errorTemplate(t)+s),this.attachBackButtonListener()}handleTabSwitch(e){this.elements.tabs.forEach(i=>i.classList.remove("active")),e.classList.add("active"),this.state.reset(),this.clearSearchInput();const s={muscles:m.MUSCLES,"body-parts":m.BODY_PARTS,equipment:m.EQUIPMENT}[e.dataset.tab]||l.DEFAULT_FILTER;this.renderFilters(s,1)}handleSearchInput(e){const t=e.target.value.trim();this.updateSearchClearButton(),this.state.clearSearchTimeout(),this.state.searchTimeout=setTimeout(()=>{this.performSearch(t)},l.SEARCH_DEBOUNCE_DELAY)}handleSearchKeydown(e){e.key==="Enter"&&(e.preventDefault(),this.state.clearSearchTimeout(),this.performSearch(e.target.value.trim()))}handleSearchClear(e){e.preventDefault(),this.clearSearch()}performSearch(e){this.state.selectedBodyPart&&this.renderExercisesList(this.state.selectedBodyPart,this.state.currentFilter,e,1)}clearSearch(){this.elements.searchInput.value="",this.updateSearchClearButton(),this.state.clearSearchTimeout(),this.state.selectedBodyPart&&this.performSearch("")}clearSearchInput(){this.elements.searchInput.value="",this.updateSearchClearButton()}updateSearchClearButton(){const e=this.elements.searchInput.value.trim().length>0;this.elements.searchClearBtn.style.display=e?"flex":"none"}attachFilterEventListeners(){this.attachFilterCardListeners(),this.attachPaginationListeners("filters")}attachExercisesEventListeners(e){this.attachBackButtonListener(),e||this.attachPaginationListeners("exercises")}attachFilterCardListeners(){this.elements.musclesGrid.querySelectorAll(".muscle-card").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.filter,s=e.dataset.filterType;this.renderExercisesList(t,s,"",1)})})}attachBackButtonListener(){const e=this.elements.musclesGrid.querySelector(".back-btn");e&&e.addEventListener("click",()=>{this.state.reset(),this.clearSearchInput(),this.renderFilters(this.state.currentFilter,1)})}attachPaginationListeners(e){this.elements.musclesGrid.querySelectorAll(".page-btn").forEach(t=>{t.addEventListener("click",()=>this.handlePagination(t,e))})}handlePagination(e,t){const{page:s}=e.dataset;let i=this.state.currentPage;s==="prev"&&this.state.currentPage>1?i=this.state.currentPage-1:s==="next"&&this.state.currentPage<this.state.totalPages?i=this.state.currentPage+1:s&&!isNaN(s)&&(i=parseInt(s)),i!==this.state.currentPage&&(this.state.currentPage=i,t==="filters"?this.renderFilters(this.state.currentFilter,i):this.renderExercisesList(this.state.selectedBodyPart,this.state.currentFilter,"",i))}init(){this.elements&&this.renderFilters(l.DEFAULT_FILTER,1)}}function w(){new O().init()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w();let v=document.getElementById("scrollTopButton");v&&(v.onclick=function(){U()});window.onscroll=function(){_()};function _(){document.body.scrollTop>20||document.documentElement.scrollTop>20?v.style.display="block":v.style.display="none"}function U(){document.body.scrollTop=0,document.documentElement.scrollTop=0}const G=document.querySelector(".nav-items"),k=document.querySelectorAll(".nav-link");var y=sessionStorage.getItem("childSelected");y===null&&(y=0);k[y].classList.add("selected");G.addEventListener("click",function(a){const e=a.target;e.classList.contains("selected")||e.localName!="a"||(k.forEach(t=>{t.classList.remove("selected")}),e.classList.add("selected"),sessionStorage.setItem("childSelected",Array.from(e.parentNode.parentNode.children).indexOf(e.parentNode)))});const d=document.getElementById("mobile-menu-btn"),u=document.getElementById("mobile-menu-backdrop");document.getElementById("mobile-menu");const x=document.getElementById("mobile-menu-close-btn"),B=document.querySelectorAll(".mobile-nav-link"),I=document.body;function j(){u.classList.add("is-open"),d.classList.add("is-active"),d.setAttribute("aria-expanded","true"),d.setAttribute("aria-label","Close mobile menu"),I.style.overflow="hidden"}function p(){u.classList.remove("is-open"),d.classList.remove("is-active"),d.setAttribute("aria-expanded","false"),d.setAttribute("aria-label","Open mobile menu"),I.style.overflow=""}function W(){u.classList.contains("is-open")?p():j()}d&&d.addEventListener("click",W);x&&x.addEventListener("click",p);u&&u.addEventListener("click",a=>{a.target===u&&p()});B.forEach(a=>{a.addEventListener("click",p)});document.addEventListener("keydown",a=>{a.key==="Escape"&&u.classList.contains("is-open")&&p()});function $(){const a=window.location.hash||"#";document.querySelectorAll(".nav-link").forEach(t=>{const s=t.getAttribute("href"),i=t.closest(".nav-item");s===a||a==="#"&&s==="./#"?i.classList.add("selected"):i.classList.remove("selected")}),B.forEach(t=>{const s=t.getAttribute("href");s===a||a==="#"&&s==="./#"?t.classList.add("active"):t.classList.remove("active")})}window.addEventListener("load",$);window.addEventListener("hashchange",$);let P="",A="";window.addEventListener("DOMContentLoaded",async()=>{try{P=await z(),q(),await F()}catch(a){console.error("Помилка ініціалізації:",a)}});window.addEventListener("resize",()=>{(window.innerWidth>=1440?"desktop":"mobile")!==A&&q()});async function z(){const e=await fetch("../partials/quote.html");if(!e.ok)throw new Error("Не вдалося завантажити quote.html");return await e.text()}function q(){const a=window.innerWidth>=1440;A=a?"desktop":"mobile";const e=document.querySelector(".exercises-sidebar"),t=document.querySelector(".exercises-page"),s=document.querySelector(".js-quote-container");s&&s.remove();const i=document.createElement("div");i.className="js-quote-container",i.innerHTML=P,a&&e?(e.innerHTML="",e.appendChild(i)):!a&&t&&(i.classList.add("container"),t.insertAdjacentElement("afterend",i)),F()}async function F(){const a=localStorage.getItem("quoteData"),e=new Date().toISOString().slice(0,10);if(a){const i=JSON.parse(a);if(i.date===e){M(i);return}}const t=await E("quote"),s={date:e,author:t.author,quote:t.quote};localStorage.setItem("quoteData",JSON.stringify(s)),M(s)}function M(a){const e=document.querySelector(".js-quote"),t=document.querySelector(".js-author");!a||!e||!t||(e.textContent=a.quote,t.textContent=a.author)}const C=()=>{const a=localStorage.getItem("favorites");try{return a?JSON.parse(a):[]}catch(e){return console.error("Failed to parse favorites:",e),[]}};class Y{constructor(e="#modal-root"){this.#r=e}#r;#i="";#t=!1;#s=0;#a="";#l="";get#e(){return document.querySelector(this.#r)}get#h(){return this.#e?.querySelector(".modal-backdrop")}get#m(){return this.#e?.querySelector("#menu-close-button")}get#d(){return this.#e?.querySelectorAll(".star-rating svg")}get#n(){return this.#e?.querySelector(".modal-rating-count")}get#o(){return this.#e?.querySelector("#send-rating-button")}get#c(){return this.#e?.querySelector("#rating-form")}get#p(){return this.#e?.querySelector("#email")}get#g(){return this.#e?.querySelector("#comment")}#v(){this.#i="",this.#s=0,this.#a="",this.#l="",this.#t=!1,this.#c&&this.#c.reset?.(),this.#n&&(this.#n.textContent="0.0"),this.#o&&this.#o.setAttribute("disabled","true")}#u(){return`
      ...
      </div>`}#y(){this.#e?.dispatchEvent(new CustomEvent("rating-modal:close",{bubbles:!0}))}#L=e=>{e.target.classList.contains("modal-backdrop")&&this.hideModal()};#f=e=>{this.#d?.forEach((t,s)=>{t.classList.toggle("hovered",s<e),t.classList.toggle("selected",s<this.#s)})};#b(){if(!this.#o)return;const e=this.#a.trim()&&this.#l.trim()&&this.#s>0;this.#o.disabled=!e}#S=async e=>{e.preventDefault();const t=new FormData(e.target),s=t.get("email")?.trim(),i=t.get("comment")?.trim();try{await D(`exercises/${this.#i}/rating`,{rate:this.#s,email:s,review:i}),this.hideModal()}catch(r){console.error("Rating submit failed:",r),alert("Failed to submit rating. Please try again later.")}};#w(){this.#d?.forEach((e,t)=>{e.addEventListener("mouseover",()=>this.#f(t+1)),e.addEventListener("mouseout",()=>this.#f(this.#s)),e.addEventListener("click",()=>{this.#s=t+1,this.#f(this.#s),this.#n&&(this.#n.textContent=this.#s.toFixed(1)),this.#b()})})}#E=e=>{e.key==="Escape"&&this.hideModal()};showModal(e){e&&(this.#i=e,this.#e.innerHTML=this.#u(),this.#h?.addEventListener("click",this.#L),this.#m?.addEventListener("click",this.hideModal),this.#c?.addEventListener("submit",this.#S),this.#p?.addEventListener("input",t=>{this.#a=t.target.value,this.#b()}),this.#g?.addEventListener("input",t=>{this.#l=t.target.value,this.#b()}),window.addEventListener("keydown",this.#E),this.#t=!0,this.#w())}hideModal=()=>{this.#t&&(window.removeEventListener("keydown",this.#E),this.#e.innerHTML="",this.#y(),this.#v())}}class K{constructor(e="#modal-root"){this.#r=e,this.#s=new Y(this.#r),this.#a.addEventListener("rating-modal:close",this.#v)}#r;#i=!1;#t={};#s=null;get#a(){return document.querySelector(this.#r)}get#l(){return document.querySelector(".modal-backdrop")}get#e(){return document.querySelector("#add-to-favorite-button")}get#h(){return document.querySelector("#give-a-rating-button")}get#m(){return document.querySelector("#menu-close-button")}#d(e){this.#t=e;const{target:t,bodyPart:s,equipment:i,gifUrl:r,name:n,description:f,rating:g,burnedCalories:b,time:H,popularity:R}=this.#t;return`<div class="modal-backdrop">
    ...
    </div>`}#n=e=>{e.target.classList.contains("modal-backdrop")&&this.hideModal()};#o=()=>{const e=C(),t=this.#t.name,s=e.findIndex(i=>i.name===t);s!==-1?e.splice(s,1):e.push(this.#t),localStorage.setItem("favorites",JSON.stringify(e)),this.#c()};#c=()=>{const e=this.#e;if(!e)return;const t=C().some(s=>s.name===this.#t.name);e.innerHTML=t?'Remove from favorites <svg><use href="./img/icons.svg#icon-trash"></use></svg>':'Add to favorites <svg><use href="./img/icons.svg#icon-heart"></use></svg>'};#p(e){const t=Math.floor(e),s=5-t;return`
  ...
  `}#g=()=>{this.hideModal(),this.#s.showModal(this.#t._id)};#v=()=>{this.showModal(this.#t)};#u=e=>{e.key==="Escape"&&this.hideModal()};showModal=e=>{this.#i||(this.#a.innerHTML=this.#d(e),this.#e?.addEventListener("click",this.#o),this.#l?.addEventListener("click",this.#n),this.#m?.addEventListener("click",this.hideModal),this.#h?.addEventListener("click",this.#g),window.addEventListener("keydown",this.#u),this.#c(),this.#i=!0)};hideModal=()=>{this.#i&&(window.removeEventListener("keydown",this.#u),this.#a.innerHTML="",this.#i=!1)}}const Q=new K,J={_id:"64f389465ae26083f39b1ab2",bodyPart:"back",equipment:"barbell",gifUrl:"https://ftp.goit.study/img/power-pulse/gifs/1316.gif",name:"barbell bent arm pullover",target:"lats",description:"These large back muscles are responsible for shoulder adduction and horizontal extension. Pull-ups and lat pulldowns are common exercises targeting the lats.",rating:3.13,burnedCalories:324,time:3,popularity:5314};Q.showModal(J);
